...
async def test_mcp_server():
    ...
    try:
        ...
        if client.process:
            try:
                stderr_data = await asyncio.wait_for(client.process.stderr.read(), timeout=2.0)
...
async def test_basic_functionality():
    ...
    try:
        ...
        print("This is expected if dependencies are missing or GEMINI_API_KEY is not set")
...
async def run_all_tests():
    ...
    try:
        ...
        print("This is expected if GEMINI_API_KEY is not set or LangGraph dependencies are missing")
